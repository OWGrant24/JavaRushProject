package Java_Collections.Collections2.RMI.task3207;
...
public class Solution {
    public static final String UNIC_BINDING_NAME = "double.string"; // Уникальное имя удаленного объекта
    ...
    public static Thread CLIENT_THREAD = new Thread(new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                String textResult = service.doubleString("Привет");
