...
Требования:
Создай класс Producer.
Создай класс Consumer.
В классе ShareItem должны быть созданы методы: toString(), equals(Object) и hashCode().
Метод run() класса Producer должен быть реализован согласно условию задачи.
Метод run() класса Consumer должен быть реализован согласно условию задачи.
Вывод должен совпадать с файлом output.txt.
     */

    public static void main(String[] args) throws InterruptedException {
        TransferQueue<Level30Task03_ShareItem> queue = new LinkedTransferQueue<>();

        Thread producer = new Thread(new Level30Task03_Producer(queue));
        Thread consumer = new Thread(new Level30Task03_Consumer(queue));
        producer.start();
        consumer.start();
