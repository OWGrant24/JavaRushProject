 ...
 */
public class Level23Task06 {
    private String country;
    private String city;

    public Level23Task06(String country, String city) {
    ...
    private class SuperUser {
        ...
        public String getDescription() {
            return String.format("My name is %s. I'm from %s in %s.", this.name, Level23Task06.this.city, Level23Task06.this.country);
        }
    }

    public static void main(String[] args) {
        Level23Task06 solution = new Level23Task06("the United States", "Seattle");
