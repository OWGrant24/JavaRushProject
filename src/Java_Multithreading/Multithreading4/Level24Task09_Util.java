...
(можешь воспользоваться Alt+Insert -> toString())
 ...
 */
public class Level24Task09_Util {
    ...
    public static List<Level24Task09_Jeans> getAllJeans() {
        //add your code here
        abstract class AbstractJeans implements Level24Task09_Jeans{
            int id;
            int length;
            int size;
            double price;
        ...
        List<Level24Task09_Jeans> allJeans = new LinkedList<>();
        ...
        for (Object[] obj : getJeansArray()) {
            ...
            Level24Task09_Jeans jeans = null;
