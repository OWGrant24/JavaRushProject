...
3. если у трэда установлена трэд-группа(ThreadGroup),
то приоритет трэда не может быть больше максимального приоритета его трэд-группы.
Требования:
...
Если у объекта MyThread установлена ThreadGroup, приоритет MyThread не должен
быть выше максимального приоритета ThreadGroup.
 */
public class Level28Task05 {
    public static void main(String[] args) {
        for (int i = 0; i < 12; i++) {
            System.out.print(new Level28Task05_MyThread().getPriority() + " ");
        }
        //output
        ...
        for (int i = 0; i < 12; i++) {
            System.out.print(new Level28Task05_MyThread(group, "name" + i).getPriority() + " ");
        }
        //output
