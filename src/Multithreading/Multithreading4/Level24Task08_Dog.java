...
public class Level24Task08_Dog implements Level24Task08_Pet {
    private String name;

    public Level24Task08_Dog(String name) {
        this.name = name;
    }
     ...
     */
    public Level24Task08_Sayable toSayable(final int i) {
        class DogPet extends Level24Task08_SuperDog implements Level24Task08_Sayable {
