...
Требования:
Метод startCreatingMessages() должен без зависаний добавлять в messageQueue 100000 элементов.
Исправь ошибку в строке "messageQueue.drainTo(messageQueue, MAX_BATCH_SIZE);".
Метод main() не должен зависать.
Вывод программы должен показывать, что все сообщения из messageQueue были перенесены в fakeDataBase.
*/

public class Level29Task05 {
    ...
    private Logger logger = Logger.getLogger(Level29Task05.class.getName());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Level29Task05 solution = new Level29Task05();
