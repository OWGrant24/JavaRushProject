package JavaRush.JavaRush_Projects.Chat.client;

import JavaRush.JavaRush_Projects.Chat.Connection;
import JavaRush.JavaRush_Projects.Chat.ConsoleHelper;
import JavaRush.JavaRush_Projects.Chat.Message;
import JavaRush.JavaRush_Projects.Chat.MessageType;
...
public class Client {
    ...
    protected String getServerAddress() { //должен запросить ввод адреса сервера у пользователя и вернуть введенное значение.
       //  Адрес может быть строкой, содержащей ip, если клиент и
        //  сервер запущен на разных машинах или 'localhost', если клиент и сервер работают на одной машине.
