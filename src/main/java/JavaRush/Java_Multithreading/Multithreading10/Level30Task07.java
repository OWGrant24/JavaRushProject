...
/*
Реализуй логику метода maxPowerOf2, который должен возвращать число 2
в максимальной степени, которое получается поместить в переданное число.
...
Требования:
В классе Solution должен присутствовать метод maxPowerOf2(int).
В классе Solution в методе maxPowerOf2(int) используй только разрешенные операции.
В классе Solution в методе maxPowerOf2(int) не используй не разрешенные операции.
Метод maxPowerOf2(int) должен возвращать число 2 в максимальной степени, которое получается поместить в переданное число.
 */
public class Level30Task07 {
