package JavaRush.Java_Multithreading.Multithreading5.task2909.car;
...
public abstract class Car {
    ...
    public int getNumberOfPassengersCanBeTransferred() {    //12
    ...
    public abstract int getMaxSpeed();   //12
}
