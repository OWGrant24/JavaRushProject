 ...
 */
public class Level26Task04 extends Thread {
    ...
    private static final Logger log = Logger.getLogger(Level26Task04.class.getName());

    private volatile static boolean debugSession = true;

    public Level26Task04() {
        this(DEFAULT_JAVARUSH_THREAD_NAME);
    }

    public Level26Task04(String name) {
