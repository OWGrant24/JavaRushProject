package JavaRush.Java_Multithreading.Multithreading8.ReentrantReadWriteLockExp;
...
P.S. Для корректной работы Map в многопоточной среде, желательно пользоваться стандартной
реализацией, например ConcurrentHashMap из пакета java.util.concurrent. Но иногда требуется
работа с другим типом мапы, например LinkedHashMap и тогда предложенное решение будет как никогда кстати.
Требования:
 ...
 */
public class Level28Task11 {
    public static void main(String[] args) {
        Level28Task11_ReadWriteMap<Integer, String> linkedSafeMap = new Level28Task11_ReadWriteMap<>(new LinkedHashMap<>());
    }
}
