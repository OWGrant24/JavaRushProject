...
public class Level29Task10_Game {
    ...
    public Level29Task10_Game() {
        ...
        for (int i = 0; i < Level29Task10_Constants.SPORTSMAN_COUNT; i++) {
    ...
    private void initializeControlSportsman() {
        ...
        controlSportsman.setChanceToHit(Level29Task10_Constants.MAX_CHANCE_TO_HIT_IN_TARGET);
    ...
    public void startCompetition() {
        for (int i = 0; i < members.size(); i++) {
            ...
            BigDecimal timeToRace = controlSportsman.getResultTime().subtract(BigDecimal.valueOf(members.get(i).getCountHitOutTarget() * Level29Task10_Constants.PENALTY_TIME_PER_ONE_MISS));
            members.get(i).setAverageSpeed(new BigDecimal(Level29Task10_Constants.RACE_LENGTH / (timeToRace.doubleValue() / 3600)).setScale(4, BigDecimal.ROUND_HALF_UP));
